...
<section class="page-header bg--cover" style="background-image: url(assets/images/header/03.jpg);">
    <div class="container">
        <div class="page-header__content text-center">
            <h2 style="color: #fff !important;">Sobre Nosotros</h2>
    ...
    <div class="container">
        <div class="section-header" data-aos="fade-up" data-aos-duration="1000">
            <div class="section-header__content">
                ...
                <p>
                    Contamos con una amplia variedad de servicios que pueden ayudar a facilitar el mantenimiento de su
                    residencia.
                </p>
            </div>
        </div>
...
<!-- ========== About Section start Here========== -->
<section class="about padding-top padding-bottom about--shape" style="background-color: #F8F5F0;">
    <div class="container">
        <div class="about__wrapper">
            <div class="row g-5">
                <div class="col-lg-6">
