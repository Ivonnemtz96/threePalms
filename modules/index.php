    ...
    <div class="hero__slider swiper">
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <div class="hero__wrapper" style="background-image:url(assets/images/hero/home1/01.jpg?=1)">
                    <div class="container">
            ...
            <div class="swiper-slide">
                <div class="hero__wrapper" style="background-image:url(assets/images/hero/home1/02.jpg?=1)">
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <div class="hero__content hero__content--center">
            ...
            <div class="swiper-slide">
                <div class="hero__wrapper" style="background-image:url(assets/images/hero/home1/03.jpg?=1)">
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <div class="hero__content hero__content--center">
        ...
        <div class="hero__slider-prev"><i class="fa-solid fa-arrow-left"></i></div>
...
<section class="service padding-top padding-bottom bg--section-color">
    <div class="container">
        ...
        <div class="service__wrapper service__wrapper--home1" data-aos="fade-up" data-aos-duration="1000"
            ...
            <div class="service__slider-prev"><i class="fa-solid fa-arrow-left"></i></div>
            <div class="service__slider-next"><i class="fa-solid fa-arrow-right"></i></div>
        </div>
    </div>
</section>
